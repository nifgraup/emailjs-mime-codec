...
define(['chai', '../src/emailjs-mime-codec'], function(chai, mimecodec) {
    ...
    describe('mimecodec', function() {
        ...
        describe('#mimeWordsDecode', function() {
            ...
            it('should not join together encoded words of different encoding', function() {
                expect(' ⏯ Trendy Netflix Redesigns + ✈️ Airport App Challenge').to.equal(mimecodec.mimeWordsDecode('=?utf-8?b?IOKPryBUcmVuZHkgTmV0ZmxpeCBSZWRlc2lnbnMgKyDinIjvuI8g?= =?utf-8?q?Airport_App_Challenge?='));
            });
